DROP VIEW IF EXISTS app.v_adviser_evaluations;
CREATE OR REPLACE VIEW app.v_adviser_evaluations AS
WITH pairings AS (
    SELECT
        t.cohort
        ...
        ,t.adviser AS evaluator_urid
        ,u.displayname AS evaluator_displayname
    FROM
        teams AS t
        JOIN user_roles AS ur ON ur.urid = t.adviser
