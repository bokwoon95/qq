...
BEGIN
    ...
    INSERT INTO form_schema (period, subsection, data)
    VALUES
        (var_pid, 'application' ,$$[
            ...
            ,{"Type":"radio","Text":"<b>Which level of achievement are you interested in?</b>","Name":"achievement_level","Options":[{"Value":"vostok","Display":"Beginner (Восто́к; Vostok)"},{"Value":"gemini","Display":"Intermediate (Project Gemini)"},{"Value":"apollo","Display":"Advanced (Apollo 11)"},{"Value":"apollo_mentor","Display":"Advanced with mentorship (Apollo 11)"}],"Subquestions":[]}
    ...
    INSERT INTO form_schema (period, data)
    VALUES
        (var_pid ,$$[
